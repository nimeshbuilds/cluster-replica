...
```bash
export REPLICOVE_EXAMPLES=https://raw.githubusercontent.com/nimeshbuilds/replicove/v0.1.0-alpha.1/examples/yaml
...
helm show values oci://ghcr.io/nimeshbuilds/charts/replicove \
  --version 0.1.0-alpha.1 > operator-values.yaml
```
