Replicove v0.2.0-alpha.1 adds optional workload mirrors: writable copies of selected host workloads and CSI volume data, with manual or scheduled resets. The host remains the source of truth; guest changes are discarded when a new generation becomes active.
