...
[PR #17](https://github.com/nimeshbuilds/replicove/pull/17) merged this source into [`aa996fc`](https://github.com/nimeshbuilds/replicove/commit/aa996fc1eb92446581833ad2e3baef09381cd2a2). At the time this record was saved, [exact-main CI](https://github.com/nimeshbuilds/replicove/actions/runs/36042461247) was still running. Published alpha.2 artifact verification and all 16 released-artifact scenario variants remain pending. Later PostgreSQL Null/Constant additions and the live pool/MCP/dashboard scenario fixtures are outside this source record; their matching scenario run is required before claiming those expanded checks passed.
